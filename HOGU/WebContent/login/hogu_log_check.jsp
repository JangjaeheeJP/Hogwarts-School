...
<div id="bf">
	...
	<div id="b">
<jsp:useBean id="member" class="mysql.DB" scope="page" />
<jsp:setProperty property="*" name="member"/>
<jsp:useBean id="data" class="mysql.HOGUDAO" scope="page" />

	<%
		String id =member.getId();
		String pass = member.getPw();
		
		if(!data.isMember(member.getId(), member.getPw())){
			
			if(data.insertMember(member) !=0){
				
				out.print("<div align='center'>");
				out.print("<br><br><br><br><br><br><br><br><br><font size='12' align='center' color='#951e13'>회원가입을 축하합니다!!.</font><br><br>");
				out.print("<a href='hogu_log.html'><input id='check' type='button' value='로그인화면으로>>'></a><br><br>");
				out.print("</div>");

			}else{
				
				out.print("<div align='center'>");
				out.print("<br><br><br><br><br><br><br><br><br><font size='12' align='center' color='#951e13'>회원가입에 실패함. 회원정보를 다시 입력해주시기 바랍니다!!</font><br><br>");
				out.print("<a href='hogu_login.html'><input id='check' type='button' value='회원가입 화면으로 돌아가기>>'></a><br><br>");
				out.print("</div>");
			...
			out.print("<div align='center'>");
			out.print("<br><br><br><br><br><br><br><br><br><font size='12' align='center' color='#951e13'>이미 가입된 정보입니다. 다시확인해주시기바랍니다!!</font><br><br>");
			out.print("<a href='hogu_login.html'><input id='check' type='button' value='회원가입 화면으로 돌아가기>>'></a><br><br>");
			out.print("</div>");
...
<%-- 	<%
		...
		if(id != null &&(id.length() !=0)){
			...
			if(id.equals("admin") && pw.equals("1234")){
				out.print("<div align='center'>");
				out.print("<br><br><br><br><br><br><br><br><br><font size='12'align='center' color='#951e13'>관리자님 어서옵쇼~</font><br><br>");
				out.print("<a href='hogu_log.html'><input id='check' type='button' value='로그인화면으로>>'></a><br><br>");
				out.print("<a href='../index.html'><input id='check' type='button' value='홈페이지로 이동'><br><br></a>");
				out.print("</div>");
			}
			else if(id.equals("강태성") && pw.equals("1234")){
				out.print("<div align='center'>");
				out.print("<br><br><br><br><br><br><br><br><br><font size='12' align='center' color='#951e13'>교수님 환영합니다!.</font><br><br>");
				out.print("<a href='hogu_log.html'><input id='check' type='button' value='로그인화면으로>>'></a><br><br>");
				out.print("<a href='../index.html'><input id='check' type='button' value='홈페이지로 이동'><br><br></a>");
				out.print("</div>");
			}
			else if(id.equals("냥냥") && pw.equals("3333")){
				out.print("<div align='center'>");
				out.print("<br><br><br><br><br><br><br><br><br><font size='12' align='center' color='#951e13'>마법사님 환영합니다.</font><br><br>");
				out.print("<a href='hogu_log.html'><input id='check' type='button' value='로그인화면으로>>'></a><br><br>");
				out.print("<a href='../index.html'><input id='check' type='button' value='홈페이지로 이동'><br><br></a>");
				out.print("</div>");
			}
				...
				out.print("<div align='center'>");
				out.print("<br><br><br><br><br><br><br><br><br><font size='12' align='center' color='#951e13'>머글이시군요!!!</font><br><br>");
				out.print("<a href='hogu_log.html'><input id='check' type='button' value='로그인화면으로>>'></a><br><br>");
				out.print("<a href='hogu_login.html'><input id='check' type='button' value='회원가입하러 가기'><br><br></a>");
				out.print("</div>");
